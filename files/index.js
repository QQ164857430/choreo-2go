...
const UUID = process.env.UUID || '782b5915-1c58-4c91-823d-975d5f98549f'; //若需要改UUID，需要在config.json里改为一致
...
const NEZHA_KEY = process.env.NEZHA_KEY || '6d2Eg0Stn9nYIzzKOA';   // 没用哪吒，把这个参数空着
